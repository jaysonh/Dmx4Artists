...
void setup()
{
   ...
   rgbLight.setParam( 0, 255 ); // set the fader channel to 255
   rgbLight.setParam( 1, 255 ); // set the red channel to 255
   rgbLight.setParam( 2, 255 ); // set the green channel to 0
   rgbLight.setParam( 3, 255 ); // set the blue channel to 0
...
void keyPressed()
{
   ...
   rgbLight.setParam( 1, ( int )random( 0, 255 ) ); // red
   rgbLight.setParam( 2, ( int )random( 0, 255 ) ); // green
   rgbLight.setParam( 3, ( int )random( 0, 255 ) ); // blue
}